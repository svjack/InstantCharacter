...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="generated_black_mv_frames", help='Directory to save generated images')
    ...
    def gen_prompt(exp):
        # 固定人物描述
        character_description = "A young man in a dark suit with black hair stands calmly by the sea at sunset, wearing a blue tie and gray vest."
    ...
    processed_dataset.save_to_disk("Black_Coastal_MV_Scenes_Descriptions")
